# Copyright 2015 Giovanni Dodero.
...
class MyFileDropTarget(wx.FileDropTarget):
	...
	self.fileTextCtrl.Bind(wx.EVT_LEFT_DCLICK,self.MyDblClick);
    #----------------------------------------------------------------------
    def MyDblClick(self, text):
        """
        To reuse box you must fill again begin data
        """
	print(self.mylabel+" cliccato!")
	#open mount point in vfs
	output=sub.check_output("xdg-open ~/taggati/tags/"+self.mylabel, shell=True)
	print(output)
